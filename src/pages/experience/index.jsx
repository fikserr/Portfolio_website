...
function Experience() {
  ...
  return (
    <div className={styles.experience}>
      <Container className={styles.experience__container}>
        <h1 className={styles.experience__title}>
          My <span>Experience</span>
        </h1>
        <div className={styles.experience__content}>
          <div className={styles.experience__card}>
            <div className={styles.experience__card_top}>
              <p className={styles.experience__card_logoText}>
                <svg
                  width="32px"
                  height="32px"
                ...
                >
                  <circle cx="512" cy="512" r="512" fill="#14a800" />
                  <path
              ...
              <p className={styles.experience__card_rightText}>
                May 2024 - Present
              </p>
            </div>
            <p className={styles.experience__card_text}>{lang.upwork}</p>
          </div>
        </div>
      </Container>
    </div>
